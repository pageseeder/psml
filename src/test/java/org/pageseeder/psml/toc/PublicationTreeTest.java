...
//    Tests.print(tree);
  ...
  public void testAutoNumberingBlockLabels() throws SAXException, IOException, XRefLoopException {
    ...
    DocumentTree tree2 = new DocumentTree.Builder(1001).title("A")
            .part(h1("A", "1", "1", 1, true, "", "issue",
                    h2("a", "2", 1, true, ""),
                    h2("b", "2", "2", 2, true, "", "issue",
                            h3("x", "3", "3",1, true, "", "issue")),
                    h2("c", "4", 1, true, ""),
                    h2("d", "4",  "4", 2, true, "", "issue",
                            h3("y", "5", 1, true, ""))))
            .addReverseReference(1L).build().normalize(TitleCollapse.auto);
    ...
    assertHasPrefix(prefixes,"1001-1-2-2","1.","a.a.",3,"1.1.1.");
    assertHasPrefix(prefixes,"1001-1-3-1","1.","a.a.a.",4,"1.1.1.1.");
    assertHasPrefix(prefixes,"1001-1-4-1",null,"1.2.",3,"1.0.2.");
    assertHasPrefix(prefixes,"1001-1-4-2","1.","a.b.",3,"1.1.2.");
    assertHasPrefix(prefixes,"1001-1-5-1",null,"1.2.1.",4,"1.0.2.1.");
    assertHasPrefix(prefixes,"1001-1-default","1.","a.",2,"1.1.");
    assertHasPrefix(prefixes,"1002-1-1-1",null,"2.",1,"2.");
    assertHasPrefix(prefixes,"1002-1-1a-1","2.","(i)",8,"2.0.0.0.0.0.0.1.");
    assertHasPrefix(prefixes,"1002-1-1b-1",null,"Table 2-1",8,"2.0.0.0.0.0.0.1.");
    assertHasPrefix(prefixes,"1002-1-1c-1","2.","(ii)",8,"2.0.0.0.0.0.0.2.");
    assertHasPrefix(prefixes,"1002-1-1d-1",null,"Table 2-2",8,"2.0.0.0.0.0.0.2.");
  ...
  public void testAutoNumberingLabels() throws SAXException, IOException, XRefLoopException {
    ...
    assertHasPrefix(prefixes,"1000-2-1-1",null,"a.b.b.",4,"0.1.2.2.");
    assertHasPrefix(prefixes,"1000-2-2-1","a.b.b.","(a)",5,"0.1.2.2.1.");
    assertHasPrefix(prefixes,"1000-2-2-2","a.b.b.","(b)",5,"0.1.2.2.2.");
    assertHasPrefix(prefixes,"1000-2-3-1","a.b.b.(b)","(i)",6,"0.1.2.2.2.1.");
    assertHasPrefix(prefixes,"1000-2-4-2","a.b.b.","(c)",5,"0.1.2.2.3.");
    assertHasPrefix(prefixes,"1000-2-5-1",null,"x.x.x.x",6,null);
    assertHasPrefix(prefixes,"1000-2-default",null,"a.b.b.",4,"0.1.2.2.");
    ...
    assertHasPrefix(prefixes,"1001-2-2-1","A.B.","(C)",5,"0.0.1.2.3.");
    assertHasPrefix(prefixes,"1001-2-2-2","A.B.","(D)",5,"0.0.1.2.4.");
    assertHasPrefix(prefixes,"1001-2-default",null,"",4,null);
  ...
  public void testAutoNumberingXRefsRelative() throws SAXException, IOException, XRefLoopException {
    ...
    assertHasPrefix(prefixes,"1000-1-1a-1",null,"3.",1,"3.");
    assertHasPrefix(prefixes,"1000-1-1b-1",null,"3.1.",2,"3.1.");
    assertHasPrefix(prefixes,"1000-1-1c-1",null,"x",1,null);
    assertHasPrefix(prefixes,"1000-1-2-1",null,"3.2.",2,"3.2.");
    assertHasPrefix(prefixes,"1000-1-2-2",null,"3.3.",2,"3.3.");
    assertHasPrefix(prefixes,"1000-1-3-1",null,"3.3.1.",3,"3.3.1.");
    assertHasPrefix(prefixes,"1000-1-4-2",null,"3.4.",2,"3.4.");
    assertHasPrefix(prefixes,"1000-1-5-1",null,"x.x.x.x",3,null);
    assertHasPrefix(prefixes,"1000-1-default",null,"2.",1,"2.");
    assertHasPrefix(prefixes,"1000-2-1-1",null,"4.4.",2,"4.4.");
    assertHasPrefix(prefixes,"1000-2-1a-1",null,"4.5.",2,"4.5.");
    assertHasPrefix(prefixes,"1000-2-1b-1",null,"4.5.1.",3,"4.5.1.");
    assertHasPrefix(prefixes,"1000-2-1c-1",null,"x",2,null);
    assertHasPrefix(prefixes,"1000-2-2-1",null,"4.5.2.",3,"4.5.2.");
    assertHasPrefix(prefixes,"1000-2-2-2",null,"4.5.3.",3,"4.5.3.");
    assertHasPrefix(prefixes,"1000-2-3-1",null,"4.5.3.1.",4,"4.5.3.1.");
    assertHasPrefix(prefixes,"1000-2-4-2",null,"4.5.4.",3,"4.5.4.");
    assertHasPrefix(prefixes,"1000-2-5-1",null,"x.x.x.x",4,null);
    assertHasPrefix(prefixes,"1000-2-default",null,"4.4.",2,"4.4.");
    assertHasPrefix(prefixes,"1001-1-1-1",null,"4.",1,"4.");
    assertHasPrefix(prefixes,"1001-1-2-1",null,"4.1.",2,"4.1.");
    assertHasPrefix(prefixes,"1001-1-2-2",null,"4.2.",2,"4.2.");
    assertHasPrefix(prefixes,"1001-1-3-1",null,"4.2.1.",3,"4.2.1.");
    assertHasPrefix(prefixes,"1001-1-4-2",null,"4.2.2.",3,"4.2.2.");
    assertHasPrefix(prefixes,"1001-1-5-1",null,"x.x.x.x",4,null);
    assertHasPrefix(prefixes,"1001-1-default",null,"4.",1,"4.");
    assertHasPrefix(prefixes,"1001-2-2-1",null,"4.5.5.",3,"4.5.5.");
    assertHasPrefix(prefixes,"1001-2-2-2",null,"4.5.6.",3,"4.5.6.");

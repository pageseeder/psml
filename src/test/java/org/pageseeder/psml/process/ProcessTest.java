...
//    System.out.println(xml);
  ...
  public void testGenerateTOC() throws IOException, ProcessException {
    ...
    Assert.assertThat(xml, hasXPath("(//heading)[2][not(@prefix)]/@level",                 equalTo("1")));
    Assert.assertThat(xml, hasXPath("(//heading)[3][@prefix='1.1.'][@level='2']/@id",      equalTo("21927-1-1-1")));
    Assert.assertThat(xml, hasXPath("(//heading)[4][not(@prefix)]/@level",                 equalTo("2")));
    Assert.assertThat(xml, hasXPath("(//heading)[5][@prefix='1.2.'][@level='2']/@id",      equalTo("21927-1-2-1")));
    Assert.assertThat(xml, hasXPath("(//heading)[6][@prefix='1.2.1.'][@level='3']/@id",    equalTo("21934-1-1-1")));
    Assert.assertThat(xml, hasXPath("(//heading)[7][@prefix='1.2.2.'][@level='3']/@id",    equalTo("21931-1-1-1")));
    Assert.assertThat(xml, hasXPath("(//heading)[8][@prefix='2.'][@level='1']/@id",        equalTo("21926-1-2-1")));
    Assert.assertThat(xml, hasXPath("(//heading)[9][@prefix='2.1.'][@level='2']/@id",      equalTo("21926-1-2-2")));
    Assert.assertThat(xml, hasXPath("(//heading)[10][@prefix='(a)'][@level='5']/@id",       equalTo("21928-1-1-1")));
    Assert.assertThat(xml, hasXPath("(//heading)[11][not(@prefix)]/@level",                equalTo("2")));
    Assert.assertThat(xml, hasXPath("(//heading)[12][@prefix='(i)'][@level='6']/@id",      equalTo("21930-4-1-1")));
    Assert.assertThat(xml, hasXPath("(//heading)[13][@prefix='(A)'][@level='7']/@id",      equalTo("21934-2-1-1")));
    Assert.assertThat(xml, hasXPath("(//heading)[14][@prefix='(ii)'][@level='6']/@id",     equalTo("21931-2-1-1")));
    Assert.assertThat(xml, hasXPath("(//heading)[15][@prefix='3.'][@level='1']/@id",       equalTo("21926-1-2-3")));
    Assert.assertThat(xml, hasXPath("(//heading)[16][@prefix='3.1.'][@level='2']/@id",     equalTo("21931-3-1-1")));
    Assert.assertThat(xml, hasXPath("(//heading)[17][@prefix='3.1.2.'][@level='3']/@id",   equalTo("219350-1-1-2")));
    Assert.assertThat(xml, hasXPath("(//heading)[18][@prefix='3.1.3.'][@level='3']/@id",   equalTo("219350-1-1-3")));
    Assert.assertThat(xml, hasXPath("(//heading)[19][@prefix='3.1.4.'][@level='3']/@id",   equalTo("219350-2-1-2")));
    Assert.assertThat(xml, hasXPath("(//heading)[20][@prefix='3.1.5.'][@level='3']/@id",   equalTo("219350-2-1-3")));
    Assert.assertThat(xml, hasXPath("(//heading)[21][@prefix='4.'][@level='1']/@id",       equalTo("21926-1-3-3")));
  ...
  public void testGenerateTOCRelative() throws IOException, ProcessException {
    ...
    Assert.assertThat(xml, hasXPath("(//heading)[4][not(@prefix)]/@level",               equalTo("2")));
    Assert.assertThat(xml, hasXPath("(//heading)[5][@prefix='1.2.'][@level='2']/@id",    equalTo("21927-1-2-1")));
    Assert.assertThat(xml, hasXPath("(//heading)[6][@prefix='2.'][@level='1']/@id",      equalTo("21934-1-1-1")));
    Assert.assertThat(xml, hasXPath("(//heading)[7][@prefix='4.'][@level='1']/@id",      equalTo("21931-1-1-1")));
    Assert.assertThat(xml, hasXPath("(//heading)[8][@prefix='5.'][@level='1']/@id",      equalTo("21926-1-2-1")));
    Assert.assertThat(xml, hasXPath("(//heading)[9][@prefix='5.1.'][@level='2']/@id",    equalTo("21926-1-2-2")));
    Assert.assertThat(xml, hasXPath("(//heading)[10][@prefix='5.1.1.'][@level='3']/@id",  equalTo("21928-1-1-1")));
    Assert.assertThat(xml, hasXPath("(//heading)[11][not(@prefix)]/@level",              equalTo("2")));
    Assert.assertThat(xml, hasXPath("(//heading)[12][@prefix='5.1.2.'][@level='3']/@id", equalTo("21930-4-1-1")));
    Assert.assertThat(xml, hasXPath("(//heading)[13][@prefix='5.1.3.'][@level='3']/@id", equalTo("21934-2-1-1")));
    Assert.assertThat(xml, hasXPath("(//heading)[14][@prefix='5.1.5.'][@level='3']/@id", equalTo("21931-2-1-1")));
    Assert.assertThat(xml, hasXPath("(//heading)[15][@prefix='6.'][@level='1']/@id",     equalTo("21926-1-2-3")));
    Assert.assertThat(xml, hasXPath("(//heading)[16][@prefix='7.'][@level='1']/@id",     equalTo("21931-3-1-1")));
    Assert.assertThat(xml, hasXPath("(//heading)[17][@prefix='7.2.'][@level='2']/@id",   equalTo("219350-1-1-2")));
    Assert.assertThat(xml, hasXPath("(//heading)[18][@prefix='7.3.'][@level='2']/@id",   equalTo("219350-1-1-3")));
    Assert.assertThat(xml, hasXPath("(//heading)[19][@prefix='7.4.'][@level='2']/@id",   equalTo("219350-2-1-2")));
    Assert.assertThat(xml, hasXPath("(//heading)[20][@prefix='7.5.'][@level='2']/@id",   equalTo("219350-2-1-3")));
    Assert.assertThat(xml, hasXPath("(//heading)[21][@prefix='8.'][@level='1']/@id",     equalTo("21926-1-3-3")));
    Assert.assertThat(xml, hasXPath("count(//para[@numbered='true'])", equalTo("7")));
